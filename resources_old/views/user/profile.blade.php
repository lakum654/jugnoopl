                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content h-body">
                                <div class="tab-pane active" id="settings">
                                    <form class="form-horizontal" id="user" method="POST" action="{{url('user/u-profile/'.$user->_id)}}" enctype="multipart/form-data">
                                        {{ method_field('PUT') }}
                                        @csrf
                                        <div class="mb-1 row">
                                ...
                                <div class="tab-pane" id="passwordreset">
                                    <form class="form-horizontal" id="user" method="POST" action="{{url('user/u-profile')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-1 row">
