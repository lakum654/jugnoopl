...
class SupplierController extends Controller
{
    ...
    public function store(SupplierValidation $request)
    {
        ...
        if (!$save->save())
          ...
          return redirect()->back()->with('msg', 'supplier not Successfully!');
     ...
     //   return response(['status' => 'success', 'msg' => 'supplier Created Successfully!']);
      ...
      return redirect()->back()->with('msg', 'supplier Created Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      return redirect()->back()->with('msg', 'supplier not Created');
